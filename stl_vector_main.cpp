...
/*   Updated: 2022/06/17 23:04:36 by mchatzip         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	delete v2;
	for (std::vector<std::string>::iterator it = v2_copy.begin(); it != v2_copy.end(); it++)
		std::cout << *it << " ";
	std::cout << std::endl << std::endl;
	...
	for (std::vector<int>::iterator it = v3_copy.begin(); it != v3_copy.end(); it++)
		std::cout << *it << " ";
	std::cout << std::endl << std::endl;
	...
	for (std::vector<int>::iterator it = v3_reverse.begin(); it != v3_reverse.end(); it++)
		std::cout << *it << " ";
	...
	std::vector<float> v4(2, 2); //v4.clear();
 	for (std::vector<float>::iterator it = v4.begin(); it != v4.end(); it++)
		std::cout << *it << " ";
	std::cout << std::endl << std::endl;
	...
	const std::vector<int> cv(v5);
	std::vector<int>::const_iterator con_it = v5.begin();
	// *con_it = 1314;
	...
	std::vector<int>::const_reverse_iterator con_rit = v5.rbegin();
	// con_rit[1] = 2;
